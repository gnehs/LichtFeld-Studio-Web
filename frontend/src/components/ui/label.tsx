...
const labelVariants = cva("text-[11px] font-semibold tracking-[0.16em] text-zinc-400 uppercase leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70");
